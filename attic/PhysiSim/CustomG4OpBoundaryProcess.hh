...
#ifndef CustomG4OpBoundaryProcess_h
#define CustomG4OpBoundaryProcess_h 1
...
class PMTSIM_API CustomG4OpBoundaryProcess : public G4VDiscreteProcess
{
public:
...
private:
#else
class            CustomG4OpBoundaryProcess : public G4VDiscreteProcess
{
#endif
...
private:
        ...
        CustomG4OpBoundaryProcess(const CustomG4OpBoundaryProcess &right);

        //////////////
        // Operators
        //////////////

        CustomG4OpBoundaryProcess& operator=(const CustomG4OpBoundaryProcess &right);
...
inline
G4bool CustomG4OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool CustomG4OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
                                                       aParticleType)
{
...
inline
G4OpBoundaryProcessStatus CustomG4OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void CustomG4OpBoundaryProcess::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
}

/**
CustomG4OpBoundaryProcess::ChooseReflection
----------------------------------------------
...
inline
void CustomG4OpBoundaryProcess::ChooseReflection()
{
...
inline
void CustomG4OpBoundaryProcess::DoAbsorption()
{
...
inline
void CustomG4OpBoundaryProcess::DoReflection()
{
...
#endif /* CustomG4OpBoundaryProcess_h */
