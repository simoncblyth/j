...
////////////////////////////////////////////////////////////////////////
//
// File:        CustomG4OpBoundaryProcess.cc
...
const plog::Severity CustomG4OpBoundaryProcess::LEVEL = SLOG::EnvLevel("CustomG4OpBoundaryProcess", "DEBUG" );
const int            CustomG4OpBoundaryProcess::PIDX  = ssys::getenvint("PIDX", -1 ); 
const bool           CustomG4OpBoundaryProcess::PIDX_ENABLED  = ssys::getenvbool("CustomG4OpBoundaryProcess__PIDX_ENABLED"); 
#endif
...
CustomG4OpBoundaryProcess::CustomG4OpBoundaryProcess(
...
G4VParticleChange*
CustomG4OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
#ifdef PMTSIM_STANDALONE
        ...
        */
        ...
        else 
        {
          ...
          ed << " CustomG4OpBoundaryProcess/PostStepDoIt(): "
                 << " The Navigator reports that it returned an invalid normal"
                 << G4endl;
          G4Exception("CustomG4OpBoundaryProcess::PostStepDoIt", "OpBoun01",
        ...
        if (OldMomentum * theGlobalNormal > 0.0) {
           ...
           ed << G4endl;
           G4Exception("CustomG4OpBoundaryProcess::PostStepDoIt", "OpBoun02",
...
void CustomG4OpBoundaryProcess::BoundaryProcessVerbose() const
{
...
G4ThreeVector
CustomG4OpBoundaryProcess::GetFacetNormal(const G4ThreeVector& Momentum,
...
/**
CustomG4OpBoundaryProcess::DielectricMetal
--------------------------------------------
...
void CustomG4OpBoundaryProcess::DielectricMetal()
{
        G4int n = 0;
...
void CustomG4OpBoundaryProcess::DielectricLUT()
{
...
void CustomG4OpBoundaryProcess::DielectricLUTDAVIS()
{
...
void CustomG4OpBoundaryProcess::DielectricDichroic()
{
        // Calculate Angle between Normal and Photon Momentum
...
//                   << std::floor(theTransmittance/perCent) << "%" << G4endl;
           ...
           G4ExceptionDescription ed;
           ed << " CustomG4OpBoundaryProcess/DielectricDichroic(): "
              << " The dichroic surface has no G4Physics2DVector"
              << G4endl;
           G4Exception("CustomG4OpBoundaryProcess::DielectricDichroic", "OpBoun03",
                       FatalException,ed,
...
void CustomG4OpBoundaryProcess::DielectricDielectric()
{
        G4bool Inside = false;
        G4bool Swap = false;
...
// ---------------
//
G4double CustomG4OpBoundaryProcess::GetMeanFreePath(const G4Track& ,
                                              G4double ,
...
G4double CustomG4OpBoundaryProcess::GetIncidentAngle() 
{
...
G4double CustomG4OpBoundaryProcess::GetReflectivity(G4double E1_perp,
                                              G4double E1_parl,
...
void CustomG4OpBoundaryProcess::CalculateReflectivity()
{
  G4double RealRindex =
...
G4bool CustomG4OpBoundaryProcess::InvokeSD(const G4Step* pStep)
{
  G4Step aStep = *pStep;
